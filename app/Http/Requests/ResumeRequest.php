...
class ResumeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'workexperince.*.currently_employed'=>'nullable|accepted',//change to true and false
            ...
            'EducationalRecord.*.currently_studying'=>'nullable|accepted',//change to true and status
